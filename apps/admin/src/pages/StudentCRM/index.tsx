...
import { getInitialChartDateRange } from '@/pages/GoogleAnalytics/components/chartjsSetup'
...
const StudentDatabase = (): JSX.Element => {
  ...
  const { checkQuota, isLoadingPermissionAndQuota } =
  ...
  const handleImportCSV = () => {
    const isQuotaEnough = checkQuota(PlanType.BASE_USER)
    if (isQuotaEnough) {
      setStudentData({
        ...studentData,
