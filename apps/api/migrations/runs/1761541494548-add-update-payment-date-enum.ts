...
export class AddUpdatePaymentDateEnum1761541494548 implements MigrationInterface {
  name = 'AddUpdatePaymentDateEnum1761541494548'
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TYPE "public"."record_logs_type_enum_old" AS ENUM('ASSIGN_COUPON_FOR_STUDENT', 'CREATE_COUPON', 'USAGE_COUPON', 'CONFIRM_USAGE_COUPON', 'DELETE_COUPON', 'INACTIVE_COUPON', 'STUDENT_CHANGE_INFOMATION', 'STUDENT_ADD_CLASS', 'STUDENT_CHANGE_TIME_TABLE', 'ADDING_CLASS', 'RESCHEDULE_LESSON', 'UPDATE_PAYMENT_AMOUNT', 'UPDATE_INVOICE_REMARK', 'DELETE_INVOICE_REMARK')`
    )
    await queryRunner.query(
