...
export class UpdateEnrollCoursesInvoiceIdToLargest1767703525000 implements MigrationInterface {
  name = 'UpdateEnrollCoursesInvoiceIdToLargest1767703525000'
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    if (multipleInvoices.length > 0) {
      console.log(
        `Found ${multipleInvoices.length} enroll_courses with multiple invoices in join table`
      )
    }
