...
export class StudentLessonRepository extends BaseAbstractRepository<StudentLesson> {
  ...
  // async getStudentLessonsCountOfLesson(classId: number, startDate: Date, endDate: Date) {
  //   // TODO -> Add a setting
  //   const studentLessonsCount = await this.count({
  //     where: {
  //       studentSchedule: {
  //         classId,
  ...
  //             },
  //       },
  //       attendance: In([AttendanceStatus.PENDING, AttendanceStatus.ATTENDED]),
